//
//  CustomMovieDetailViewController.swift
//  NetflixMVP
//
...
class CustomMovieDetailViewController: UIViewController {
    
    static var identifier : String {
        return "CustomMovieDetailViewController"
    }
        ...
        @IBOutlet weak var btnPlayTrailer: CommonButton!
        ...
        override func viewDidLoad() {
            ...
            btnPlayTrailer.backgroundColor = .systemRed
        ...
        func registerView() {
             ...
             //collectionViewSimilarMovie.register(UINib(nibName: CustomSimilarCollectionViewCell.identifier, bundle: nil), forCellWithReuseIdentifier: CustomSimilarCollectionViewCell.identifier)
             collectionViewSimilarMovie.register(CustomSimilarCollectionViewCell.self, forCellWithReuseIdentifier: String(describing: CustomSimilarCollectionViewCell.self))
    ...
    extension CustomMovieDetailViewController : MovieDetailView {
    ...
    extension CustomMovieDetailViewController : UICollectionViewDataSource {
        ...
        func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: CustomSimilarCollectionViewCell.identifier, for: indexPath) as? CustomSimilarCollectionViewCell else {
    ...
    extension CustomMovieDetailViewController : UICollectionViewDelegate {
