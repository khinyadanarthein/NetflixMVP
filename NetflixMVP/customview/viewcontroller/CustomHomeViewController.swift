...
class CustomHomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       NSLayoutConstraint.activate([
           tableViewHome.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 0),
           tableViewHome.trailingAnchor.constraint(equalTo: self.view.trailingAnchor, constant: 0),
           tableViewHome.bottomAnchor.constraint(equalTo: self.view.bottomAnchor, constant: 0),
           tableViewHome.topAnchor.constraint(equalTo: self.view.topAnchor, constant: 0)
...
extension CustomHomeViewController : MovieListView {
...
extension CustomHomeViewController : UITableViewDataSource,UITableViewDelegate {
...
extension CustomHomeViewController : MovieDelegate {
