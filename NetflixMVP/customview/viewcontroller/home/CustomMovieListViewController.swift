//
//  CustomMovieListViewController.swift
//  NetflixMVP
//
...
class CustomMovieListViewController: UIViewController {
    ...
    extension CustomMovieListViewController : MovieListView {
    ...
    extension CustomMovieListViewController : UITableViewDataSource {
    ...
    extension CustomMovieListViewController : MovieDelegate {
    ...
    extension CustomMovieListViewController : UITableViewDelegate {
        
    }
    //
    extension CustomMovieListViewController : UITabBarControllerDelegate {
