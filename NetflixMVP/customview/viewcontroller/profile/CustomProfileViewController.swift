...
class CustomProfileViewController: UIViewController {
    ...
    func registerView() {
        ...
        collectionViewRateList.register(CustomSimilarCollectionViewCell.self, forCellWithReuseIdentifier: String(describing: CustomSimilarCollectionViewCell.self))
        collectionViewWatchList.register(CustomSimilarCollectionViewCell.self, forCellWithReuseIdentifier: String(describing: CustomSimilarCollectionViewCell.self))
...
extension CustomProfileViewController : ProfileView {
...
extension CustomProfileViewController : UICollectionViewDataSource {
...
extension CustomProfileViewController : UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
