/**
 ...
 DataModel ကို Test လုပ်ဖို့အတွက် အောက်ပါ property နှစ်ခုကို stub လုပ်ပေးရပါမယ်။
 let api:MovieApi
 let db :Dao
 
 လက်ရှိရေးထားတဲ့ ပုံစံအရ DataModelImpl ကိုတိုက်ရိုက်ခေါ်သုံးထားတယ်။
 Actual Network Call အလုပ်လုပ်သွားသလို
 Database ကလည်း Realm Database ကို access လုပ်နေတယ်။
