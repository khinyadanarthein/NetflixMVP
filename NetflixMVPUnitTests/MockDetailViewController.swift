/**
 ...
 DetailViewController တစ်ခုလုံး Mock လုပ်ဖို့မလိုပါ။
 DetailsViewController နဲ့ DetailViewController မှာသုံးထားတဲ့ Presenter ကို Test လုပ်ဖို့ပဲလိုမှာပါ။
 Please check MockSearchViewController for more. 
